...
fn main() {
    ...
    // BUG:
    // PESAN TIDAK BISA DIENKRIPSI APABILA HASIL ENKRIPSI SUATU KARAKTER MENGEMBALIKAN NILAI > 255
    // HAL INI DIKARENAKAN FUNGSI DECRYPT_FROM_B64 TIDAK MAMPU MEMERIKSA ANGKA DENGAN PANJANG HEX BERVARIASI
    // ANTARA 2, 3, DST.
    // SOLUSI:
    // 1. PADDING MUNGKIN BISA DITERAPKAN UNTUK MEMBATASI BAGIAN HEX DARI SUATU BILANGAN
    //    MISALKAN -> 22#334 BERARTI BAHWA ADA 2 BILANGAN, YAITU 22 DAN 334 (DALAM HEX)
    //    JIKA TANPA PADDING -> 22334 -> 22 33 4 -> ADA 3 BILANGAN DAN MENGAKIBATKAN KEGAGALAN DEKRIPSI
    //    [ SULIT DITERAPKAN ]
    // 2. GUNAKAN NILAI P <= 255
    //    HAL INI AKAN MENJAMIN HASIL ENKRIPSI KARAKTER AKAN MENGEMBALIKAN BILANGAN PADA RENTANG [0, 255]
    //    SEHINGGA REPRESENTASI HEX AKAN SERAGAM, YAITU 2 BUAH DIGIT HEX
    // 3. ENCRYPT SEMUA STRING SEKALIGUS
    //    SYARAT: PERLU BILANGAN PRIMA YANG BESAR
    //            PANJANG BIT PESAN <= PANJANG BIT BILANGAN PRIMA
    let p = BigInt::from(3023);
